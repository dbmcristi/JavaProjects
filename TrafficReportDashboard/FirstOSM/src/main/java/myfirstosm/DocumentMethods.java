...
public class DocumentMethods {
	/** 
	 * Given an XML Document it returns a String containing the Document
	 * Method is from http://www.programcreek.com/java-api-examples/index.php?api=org.w3c.dom.Document
	 * @param doc
	 * @return
	 * @throws Exception
	 */
